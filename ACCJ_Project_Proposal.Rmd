...
* COVID-19, caused by a coronavirus called SARS-CoV-2, is a pandemic that has led to the global instability of economies, governments, and life as we once knew. Its pervasiveness, exceptional rate of transmissibility, and virulence are key aspects of why this virus has led to unprecedented levels of fatalities and global disruption of everyday life. COVID-19 has left an indelible impact on the world, having entered the top ten of world’s worst pandemics, totaling over 2.7 million deaths worldwide. A phenomenon of this scale necessitates constant surveillance and data analysis to mitigate further fatalities. To that end, a COVID-19 Informational Shiny App could synthesize the troves of data surrounding this pandemic and inform users of dispersion across geographic areas, project future mortality rates, track daily caseloads, among additional functionalities. 

# Proposed data sorces.

* CDC or DC Open Data
* Data collection method: APIs
